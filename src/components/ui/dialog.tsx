  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 w-[min(92vw,440px)] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-border bg-surface p-6 shadow-none outline-none",
      ...
      >
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <DialogPrimitive.Close className="rounded-sm p-1 text-muted hover:bg-surface-2 hover:text-fg">
            <X className="size-4" />
